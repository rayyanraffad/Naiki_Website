...
export default function Mission() {
  return (
    <section id="mission" className="lg:h-full flex flex-col lg:flex-row overflow-hidden">
      ...
      {/* Right – copy */}
      <div className="flex-[58] flex flex-col px-6 sm:px-10 md:px-14 py-8 md:py-10 relative overflow-hidden" style={{ backgroundColor: "#FAFAF8" }}>
        {/* Ghost number */}
        <div
          aria-hidden="true"
          className="pointer-events-none select-none absolute right-4 top-2 font-black leading-none"
          style={{ fontSize: "clamp(8rem,22vw,18rem)", color: "rgba(27,67,50,0.04)", lineHeight: 1 }}
        >
          01
        </div>
        ...
        >
          <h2
            ...
            style={{ fontSize: "clamp(2.2rem, 5.5vw, 5.5rem)", color: "#111827" }}
          >
            Why Naiki<br />exists.
          </h2>
          <div className="space-y-4 text-sm sm:text-base md:text-[17px] leading-relaxed" style={{ color: "#6B7280", maxWidth: "520px" }}>
            <p>
